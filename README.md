...
Sou graduando em Sistemas de Informação no IFES e atuo como pesquisador bolsista (FAPES), focando em **Neuroevolução** e **Séries Temporais**. Minha paixão por tecnologia começou cedo, no hardware, e evoluiu para a resolução de problemas complexos através de código.

Atualmente, meus interesses principais são:
* 🧠 **IA & Machine Learning:** TensorFlow, Neuroevolução, Visão Computacional.
* 📊 **Ciência de Dados:** Análise estatística (ARIMA/SARIMA).
* 🌐 **Desenvolvimento:** Front-end e estruturas de dados eficientes.

---

## 🛠️ Tecnologias & Ferramentas

O portfólio destaca projetos desenvolvidos com as seguintes tecnologias:
...
* **[X-Ray Simulator](https://github.com/Elizetaa/X-Ray-Simulation):** Simulação em C usando filas dinâmicas e gerenciamento rigoroso de memória.
* **[Biblioteca AVL](https://github.com/DrTrigger/Trabalho2ArvoresBinarias/edit/main/README.md):** Implementação genérica de árvores binárias auto-balanceáveis em Java.
* **Polinômio de Taylor:** Algoritmos numéricos para aproximação de funções matemáticas.
...
* Customizações e Conteúdo: **Luiz Felipe Elizeta**.

---

## 📫 Contato

Sinta-se à vontade para entrar em contato para colaborações ou discussões sobre IA!

<div align="center">
  <a href="https://www.linkedin.com/in/luiz-elizeta/" target="_blank">
    <img src="https://img.shields.io/badge/-LinkedIn-%230077B5?style=for-the-badge&logo=linkedin&logoColor=white" target="_blank">
  </a> 
  <a href="mailto:luiz.elizeta@gmail.com">
